...
public class Entrenamiento_Sit extends AppCompatActivity {
    Button siguientetruco;
    ImageButton btnhome;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_entrenamiento__sit);

        btnhome = (FloatingActionButton)findViewById(R.id.botonhomesit);
        ...
        siguientetruco.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Entrenamiento_Sit.this, Entrenamiento_Plaz.class));
                finish();
            }
        });
    }
